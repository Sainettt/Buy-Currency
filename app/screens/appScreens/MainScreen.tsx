...
const MainScreen: React.FC<MainProps> = ({ navigation } : MainProps) => {
    ...
    // useEffect на инфо о трендовых валютах и балансе юзера
    return (
        <View style={appStyles.flexContainer}>
            ...
            <View style={appStyles.balanceContainer}>
                ...
                <TouchableOpacity style={appStyles.topUpButton} onPress={() => {navigation.navigate('PaymentMethod')}}>
                    <Text style={appStyles.topUpText}>Top Up</Text>
                </TouchableOpacity>
            </View>
            <InfoTrendCurrencies />
            <View style={appStyles.viewAllContainer}>
                <TouchableOpacity style={appStyles.viewAllButton} onPress={() => {navigation.navigate('AllCurrencies')}}>
