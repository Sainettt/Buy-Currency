...
type PaymentMethodProps = NativeStackScreenProps<AppStackParamList, 'PaymentMethod'>;
    ...
    return (
        <View style={appStyles.flexContainer}>
            <View style={appStyles.container}>
                ...
                <PaymentMethodContainer logo={require('../../assets/images/applePay.png')} styleLogo={styles.logoApplePayContainer} onPress={() => {navigation.navigate('BalanceTopUp')}} />

                <View style={styles.marginTextPaymentMethod}>
                    <Text style={styles.textPaymentMethod}> Other </Text>
                </View>
                <PaymentMethodContainer logo={require('../../assets/images/blik.png')} styleLogo={styles.logoBlikContainer} onPress={() => {navigation.navigate('BalanceTopUp')}} />
            </View>
            <BottomBar
